namespace EventServer.Infrastructure.Providers
{
    ...
    {
        private readonly IRepository repository = DependencyResolver.Current.GetService<IRepository>();
        ...
        public override MembershipUser CreateUser(string username, string password, string email, string passwordQuestion, string passwordAnswer, bool isApproved, object providerUserKey, out MembershipCreateStatus status)
        {
            ...
            return Map(this.repository.Save(new UserProfile(email, password)));
        }
        ...
        {
            var users = this.repository.Find<UserProfile>().ToArray();
